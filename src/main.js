...
const paintColor = "rgba(118, 94, 244, 0.72)";
...
const faces = {
  bottom: createFace("Bottom", "bottom", -1, -1, 0, true, 0.08),
  back: createFace("Back", "back", -1, 1, 0, true, 0.08),
  side: createFace("Side", "side", -1, 1, 0, true, 0.08)
};
